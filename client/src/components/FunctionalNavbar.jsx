...
import { 
  Search, X, MapPin, Calendar, TrendingUp, Clock,
  Menu, User, Bell, ChevronDown, Plane, Building2,
  Package, Train, Bus, Car, Heart, ShoppingBag
} from 'lucide-react';
...
const FunctionalNavbar = () => {
  ...
  // Navigation items with exact functionality
  const navItems = [
  ...
  useEffect(() => {
    ...
    const mockNotifications = [
      ...
      },
      {
        ...
        message: 'Your payment of ₹15,999 was successful',
        time: '1 day ago',
        read: true,
        type: 'success'
      }
                      ...
                      <div className="absolute right-0 top-full mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-xl py-2 z-50">
                        <div className="px-4 py-3 border-b border-gray-100">
                          ...
                          <div className="text-sm text-gray-500">
                            {user?.email || 'user@travelease.com'}
                          </div>
                        </div>
